...
add     r3,#2    @add 2 to the attacker's hit, approximating +4 luck
strh    r3,[r0]     @Store attacker hit.
add     r0,#0x62    @Move to the attacker's avoid.
ldrh    r3,[r0]     @Load the attacker's avoid into r3.
add     r3,#4    @add 4 to the attacker's avoid, approximating +4 luck
...
add     r3,#4    @add 4 to the attacker's crit avoid, approximating +4 luck
